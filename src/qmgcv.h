...
/* ... note also that there is no actual *need* to protect #pragmas with 
  ...
  non-avoidable use of these in the qmgcv code. */
...
extern void qmgcv_mmult(double *A,double *B,double *C,int *bt,int *ct,int *r,int *c,int *n);
...
void qmgcv_symeig(double *A,double *ev,int *n,int *use_dsyevd, int *get_vectors,int *descending);
