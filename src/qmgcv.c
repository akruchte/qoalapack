/* Source code for qmgcv.dll/.so multiple smoothing parameter estimation code,
...
7. 31/10/01: qmgcv.c covariance and edf calculations made more robust - for poorly conditioned 
...
16.23/10/02: qmgcv modified in order to check that Tr(A) calculations are sensible, and that termwise 
